...
class TestShop:
    def test_add_category(self, grpc_stub):
    ...
    def test_add_product_with_invalid_category_id(self, grpc_stub):
    ...
    def test_add_product_with_valid_category_id(self, grpc_stub):
    ...
    def test_add_product_negative_price(self, grpc_stub):
    ...
    def test_add_product_with_too_long_name(self, grpc_stub):
...
class TestUsers:
    def test_register_user_success(self, grpc_stub_user):
        username = "test_user"
    ...
    def test_register_user_existing(self, grpc_stub_user):
        username = "test_user"
        email = "test@example.com"
        password = "test_password"
    ...
    def test_authenticate_user_success(self, grpc_stub_user):
    ...
    def test_authenticate_user_invalid_credentials(self, grpc_stub_user):
        username, email, password = "test_user", "test@example.com", "test_password"
        request = product_pb2.RegisterUserRequest(username=username, email=email, password=password)
        _ = grpc_stub_user.RegisterUser(request)
